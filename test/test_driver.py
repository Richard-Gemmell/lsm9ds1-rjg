...
from lsm9ds1_python.driver import Driver
from lsm9ds1_python.abstract_transport import AbstractTransport


class DriverTest(unittest.TestCase):
    @patch('lsm9ds1_python.abstract_transport.AbstractTransport')
    @patch('lsm9ds1_python.abstract_transport.AbstractTransport')
